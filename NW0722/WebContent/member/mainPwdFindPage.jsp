...
<link rel='stylesheet' href='../css/mainPwdFind.css'>
</head>
<body>
	<div id="wrap">
		<div id="header">
			...
			<div id="id_fine_content">
				<div class="wrap_account">
					...
					<div class='cont_find'>
						...
						<form action='mainPwdFindPage.so' method='post' name='findPwdFrm'>
							<input class='input_all' type='text' name='id' id='id'
								placeholder='아이디입력'> <br> <input class='input_all'
								type='text' name='name' id='name' placeholder='이름입력'> <br>
							<input class='input_all' type='text' name='email' id='email'
								placeholder='이메일 입력'> <br> <input id='check_id'
								type='submit' value='확인'>
						</form>
						
						<div class='find_account'>
							<a href='mainIDFindPage.jsp' class='link_find' id='find_id'>아이디
								찾기 </a>&nbsp;&nbsp;| <a href='signupPage.jsp' class='link_find'
								id='join_in'>&nbsp;&nbsp;회원가입
								</a>
						</div>
					</div>
