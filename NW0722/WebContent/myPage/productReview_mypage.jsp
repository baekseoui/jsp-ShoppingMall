...
<table class="tableSet" style="table-layout: fixed; width: 504px">
	...
	<input type="hidden" name="boardNum" value="${rDto.boardNum }"/>
		<tr>
			...
			<a href="../productDetails/productDetails_view.po?productId=${rDto.productID }">
                   <div id="pictures">${rDto.picture }</div> 
             </a></th>
		...
		<c:choose>
			...
			<td class="set" colspan="4" rowspan="2" ><img src="../tempUpload/${dto1.fileNewName}"></td>
			</c:when>
		</c:choose>
		</c:forEach>	
		</tr>
		...
		<tr>
			...
			<td class="set" colspan="2" id="control"><a href="index9_update.so?customerID=${rDto.customerID }&boardNum=${rDto.boardNum }">수정</a></td>
			<td class="set" colspan="2" id="control"><a href="index9_delete.so?boardNum=${rDto.boardNum }" onclick="deleteOk();">삭제</a></td>
		</tr>
