		...
		<div id="header">
			...
			<div id="contents">
				<div id="total_list">
					...
					<div id=slide_list><img src ='../img/Category/beverages.jpg' width = "1034px"></div>
					<div id=main_list>
						...
						<ul class="mass_list">
							<c:forEach items="${dtos}" var="dto">
								<div id="main"
									...
									<div id="name" style='margin-top: 20px; font-size: 20px; color:#6A6B6D; width:210px;'><b>${dto.productName }</b></div>
